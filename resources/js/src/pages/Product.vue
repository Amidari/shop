                                ...
                                <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                                    ...
                                    <ul class="color-option">
                                        <li v-for="color in filterList.colors">
                                            <a @click.prevent="addColor(color.id)" href="#0" class="color-option-single" :style="`background: ${color.title}; border: 1px`"> <span> Цвет</span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="single-sidebar-box mt-30 wow fadeInUp animated">
                                                            ...
                                                            <div class="row justify-content-between align-items-center">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="popup-right-content">
                                                                        ...
                                                                        <div class="price">
                                                                            <h2> $42 USD <del> {{popupProduct.price}}</del></h2>
                                                                            <h6> In stuck</h6>
                                                                        </div>
                                                                        <div class="color-varient">
                                                                            <template v-for="groupProduct in popupProduct.group_products">
                                                                            <a @click.prevent="getProduct(groupProduct.id)" v-for="color in groupProduct.colors" href="#0" :style="`background: ${color.title};`" class="color-name"></a>
                                                                            </template>
                                                                        </div>
