            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Редактировать "{{$product->title}}"</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <form action="{{route('product.update', $product->id)}}" method="post">
                    ...
                    <div class="form-group">
                        <select name="tags[]" class="tags" multiple="multiple" data-placeholder="Выбериет тег" style="width: 100%;">
                            @foreach($tags as $teg)
                    ...
                    <div class="form-group">
                        <select name="colors[]" class="colors" multiple="multiple" data-placeholder="Выбериет цвет" style="width: 100%;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="exampleInputFile">{{$product->preview_image}}</label>
                            </div>
